...
(product_services_companies.json). Nothing else is reachable.
  ...
  python apply_companies_supabase_event.py <workbook_name> --recon
  python apply_companies_supabase_event.py <workbook_name> --dry-run
  python apply_companies_supabase_event.py <workbook_name> [--run]
"""
    ...
    for attempt in range(4):
        try:
            ...
            if attempt % 2 == 0:
                ...
                B.open_enrichment_search(page, TEMPLATE)
