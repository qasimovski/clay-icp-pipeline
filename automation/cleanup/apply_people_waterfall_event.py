...
WORK EMAIL is the "already applied" signature.
  ...
  python apply_people_waterfall_event.py <wid> <name> "Sellers - People" --recon
  python apply_people_waterfall_event.py <wid> <name> "Sellers - People" --dry-run
  python apply_people_waterfall_event.py <wid> <name> "Sellers - People" [--run]
"""
...
import apply_email_template_event as T      # noqa: E402  (_click_opt_scroll)
...
# through beside the panel (see apply_email_template_event for why this matters).
