...
Mirrors apply_gsheet_event.py's structure: --recon to inspect the template's
...
# --recon before real use (see apply_gsheet_event.py's SIG discovery process;
...
# Same config-panel field-box locator as apply_v1_event.py: find the label's
