...
Not a CLI entry point on its own; cleanup_rollout.py drives it. But it can be
...
import common         # noqa: E402  (clay_page context manager)
...
def _validate_single(workbook_id_or_name, dry_run=True, headed=True):
    ...
    with common.clay_page(headless=not headed) as page:
